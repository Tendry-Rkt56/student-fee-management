...
<body>
     ...
     <div style="box-shadow:-4px 4px 10px 0Px rgba(0,0,0,0.4);padding:30px;position:absolute;top:20%;left:220px;width:calc(100% - 200px)">
          <div class="container-fluid d-flex align-items-center justify-content-center flex-column gap-3">
               <h2 class="align-self-start">Edition</h2>
               ...
               <form method="POST" action="" enctype="multipart/form-data" class="justify-self-start align-self-start container d-flex align-items-center justify-content-start flex-column gap-3">
                    <div class="row container">
                         <div class="col-sm-6 d-flex align-items-center justify-content-center flex-row gap-1">
                              ...
                              <input value="<?=$student->nom?>" style="width:80%" type="text" name="nom" id="nom" class="form-control" placeholder="Nom...">
                         </div>
                         <div class="col-sm-6 d-flex align-items-center justify-content-center flex-row gap-1">
                              <label style="width:20%" for="prenom" class="fw-bolder">Prénom:</label>
                              <input value="<?=$student->prenom?>" style="width:80%" type="text" name="prenom" id="prenom" class="form-control" placeholder="Prénom...">
                         </div>
                    </div>
                    <div class="row container">
                         <div class="col-sm-6 d-flex align-items-center justify-content-center flex-row gap-1">
                              ...
                              <select style="width:80%" name="classe" id="classe" class="form-select">
                                   <?php foreach($classes as $classe): ?>
                                        <option <?php if ($student->nomClass == $classe->id): ?> selected <?php endif ?> value="<?=$classe->id?>"><?=$classe->nom?></option>
                                   <?php endforeach ?>
                              </select>
                         </div>
                         <div class="col-sm-6 d-flex align-items-center justify-content-center flex-row gap-1">
                              <label style="width:20%" for="dob" class="fw-bolder">Date de naissance:</label>
                              <input  value="<?=$student->dob?>"style="width:80%" type="date" name="dob" id="dob" class="form-control" placeholder="Date de naissance...">
                         </div>
                    </div>
                    <div class="row container">
                         <div class="col-sm-6 d-flex align-items-center justify-content-center flex-row gap-1">
                         ...
                         <div class="col-sm-6 d-flex align-items-center justify-content-center flex-row gap-1">
                              <label style="width:20%" for="dob" class="fw-bolder">Contact:</label>
                              <input style="width:80%" type="text" name="contact" id="dob" class="form-control" placeholder="+261...">
                         </div>
                    </div>
