          ...
          <div style="box-shadow:-4px 4px 10px 0Px rgba(0,0,0,0.4);padding:30px;position:absolute;top:20%;left:220px;width:calc(100% - 200px)">
               <div class="container-fluid d-flex align-items-center justify-content-center flex-column gap-3">
                    ...
                    <form method="POST" action="" enctype="multipart/form-data" class="justify-self-start align-self-start container d-flex align-items-center justify-content-start flex-column gap-3">
                         ...
                         <div class="row container">
                              <div class="col-sm-6 d-flex align-items-center justify-content-center flex-row gap-1">
                                   <label style="width:20%" for="email" class="fw-bolder">Email:</label>
                                   <input type="text" style="width:80%;" name="email" placeholder="Email..." class="form-control" id="email">
                              </div>
                              <div class="col-sm-6 d-flex align-items-center justify-content-center flex-row gap-1">
                                   <label style="width:20%" for="image" class="fw-bolder">Mot de passe:</label>
                                   <input type="text" name="password" class="form-control" style="width:80%" placeholder="Mot de passe">
                              </div>
                         </div>
                         <div class="row container">
                              <div class="col-sm-6 d-flex align-items-center justify-content-center flex-row gap-1">
                                   <label style="width:20%" for="email" class="fw-bolder">Image:</label>
                                   <input type="file" style="width:80%;" name="image" placeholder="Image associée..." class="form-control" id="image">
                              </div>
                         </div>
